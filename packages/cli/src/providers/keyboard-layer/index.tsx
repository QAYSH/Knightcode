...
createContext<KeyboardLayerContexValue | null>(null);
...
export function useKeyboardLayer(){
    const context = useContext(KeyboardLayerContext);
     if  (!context) {
         throw new  Error("useKeyboardLater must be used within a KeyboardLayerProvider")                
      }  
    return context;                   
}  