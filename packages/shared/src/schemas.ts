...
export const readOnlyToolContracts = {
    ...
    listDirectory: tool({
        description: "List entries in directory under the current project directory.",
        inputSchema: toolInputSchemas.listDirectory,
    }),

    glob: tool({
        description: "Find files matching a glob pattern under the surrent project directory.",
